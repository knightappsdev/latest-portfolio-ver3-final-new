        ...
        <div className="text-center lg:text-left lg:flex lg:items-center lg:justify-between">
          ...
          <div className="mb-8 lg:mb-0 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-lime-400 animate-continuous-glow">
                <img
              ...
              <div className="absolute top-1/4 -left-6 w-4 h-4 bg-lime-300 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
              <div className="absolute bottom-1/4 -right-6 w-5 h-5 bg-primary-400 rounded-full animate-bounce" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
