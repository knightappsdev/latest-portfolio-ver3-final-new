          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-500 leading-relaxed">
                ...
                Based in London, serving clients worldwide from ofemo.uk.
              </p>
            </div>
            ...
            <div className="flex space-x-4">
              {[
                ...
                { icon: 'bi-envelope', url: 'mailto:connect@ofemo.uk', label: 'Email' },
              ].map((social, index) => (
                <a
                  key={index}
                  href={social.url}
        ...
        <div className="border-t border-dark-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-500 text-sm mb-4 md:mb-0">
              © {currentYear} Olufemi Olagbaju | ofemo.uk. All rights reserved.
            </div>
