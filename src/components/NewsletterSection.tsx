...
import { sendNewsletterWithFallback } from '../services/serverEmailService';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Get exclusive insights, project updates, and industry tips from ofemo.uk 
          ...
          <div className="max-w-md mx-auto">
            <div className="flex items-center justify-center p-4 bg-lime-500/20 border border-lime-500/50 rounded-lg">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-300 text-sm">Thank you for joining the ofemo.uk newsletter.</p>
              </div>
            </div>
          </div>
        )}
