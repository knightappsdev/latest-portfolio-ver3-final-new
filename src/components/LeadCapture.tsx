...
import { sendLeadCaptureEmail } from '../services/serverEmailService';
...
const LeadCapture: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await sendLeadCaptureEmail({
        email,
        ...
        <div className="bg-dark-800 rounded-2xl p-8 max-w-md w-full mx-4 border border-dark-700 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400">
              Get exclusive insights and project updates from ofemo.uk delivered to your inbox.
            </p>
          </div>
        ...
        <div className="bg-dark-800 rounded-xl p-6 border border-dark-700 shadow-xl">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Get project updates from ofemo.uk</p>
            </div>
          </div>
